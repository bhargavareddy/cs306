...
/*************************** Class Comparison_IC_Stmt *****************************/

Comparison_IC_Stmt::Comparison_IC_Stmt(Tgt_Op op, Ics_Opd * o1,Ics_Opd * o2, Ics_Opd * res)
{
	CHECK_INVARIANT((machine_dscr_object.spim_instruction_table[op] != NULL),
			"Instruction description in spim table cannot be null");
...
Ics_Opd * Comparison_IC_Stmt::get_opd1()          { return opd1; }
Ics_Opd * Comparison_IC_Stmt::get_opd2()		  { return opd2;}
Ics_Opd * Comparison_IC_Stmt::get_result()        { return result; }

void Comparison_IC_Stmt::set_opd1(Ics_Opd * io)   { opd1 = io; }
void Comparison_IC_Stmt::set_opd2(Ics_Opd * io)   { opd2 = io; }
void Comparison_IC_Stmt::set_result(Ics_Opd * io) { result = io; }

Comparison_IC_Stmt& Comparison_IC_Stmt::operator=(const Comparison_IC_Stmt& rhs)
{
	op_desc = rhs.op_desc;
	opd1 = rhs.opd1;
	opd2 = rhs.opd2;
...
void Comparison_IC_Stmt::print_icode(ostream & file_buffer)
{
...
If_else_IC_Stmt::If_else_IC_Stmt(Tgt_Op op, Ics_Opd * o1, int temp_res)
{
	CHECK_INVARIANT((machine_dscr_object.spim_instruction_table[op] != NULL),
			"Instruction description in spim table cannot be null");
...
Ics_Opd * If_else_IC_Stmt::get_opd1()          { return opd1; }
int If_else_IC_Stmt::get_value()        { return result; }

void If_else_IC_Stmt::set_opd1(Ics_Opd * io)   { opd1 = io; }
void If_else_IC_Stmt::set_value(int temp_res) { result = temp_res; }

If_else_IC_Stmt& If_else_IC_Stmt::operator=(const If_else_IC_Stmt& rhs)
{
	op_desc = rhs.op_desc;
	opd1 = rhs.opd1;
	result = rhs.result; 
...
void If_else_IC_Stmt::print_icode(ostream & file_buffer)
{
	...
	case i_r_op_o1: 
			...
			opd1->print_ics_opd(file_buffer);
			file_buffer << " , ";
			zero_register->print_ics_opd(file_buffer);
			file_buffer<< " : goto "<<l;
			file_buffer << "\n";
...
GOTO_IC_Stmt::GOTO_IC_Stmt(Tgt_Op op, int temp_res)
{
	CHECK_INVARIANT((machine_dscr_object.spim_instruction_table[op] != NULL),
			"Instruction description in spim table cannot be null");
...
int GOTO_IC_Stmt::get_value()        { return result; }

void GOTO_IC_Stmt::set_value(int temp_res) { result = temp_res; }
...
BB_IC_Stmt::BB_IC_Stmt( int temp_res)
{  
	result = temp_res; 
}

int BB_IC_Stmt::get_value()        { return result; }

void BB_IC_Stmt::set_value(int temp_res) { result = temp_res; }

BB_IC_Stmt& BB_IC_Stmt::operator=(const BB_IC_Stmt& rhs)
{
	result = rhs.result; 
...
void BB_IC_Stmt::print_icode(ostream & file_buffer)
{
