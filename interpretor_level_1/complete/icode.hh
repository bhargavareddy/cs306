...
class Comparison_IC_Stmt: public Icode_Stmt
{ 
	Ics_Opd * opd1;
	Ics_Opd * opd2;   
	Ics_Opd * result; 
...
public:
	Comparison_IC_Stmt(Tgt_Op inst_op, Ics_Opd * opd1,Ics_Opd * opd2, Ics_Opd * result); 
	~Comparison_IC_Stmt() {} 
	Comparison_IC_Stmt & operator=(const Comparison_IC_Stmt & rhs);
...
class If_else_IC_Stmt: public Icode_Stmt
{
	Ics_Opd * opd1;   
	int result; 

public:
	If_else_IC_Stmt(Tgt_Op inst_op, Ics_Opd * opd1,int temp_res); 
	~If_else_IC_Stmt() {} 
	If_else_IC_Stmt & operator=(const If_else_IC_Stmt & rhs);
...
public:
	GOTO_IC_Stmt(Tgt_Op inst_op, int temp_res);
	~GOTO_IC_Stmt();
...
class BB_IC_Stmt: public Icode_Stmt
{
	int result;

public:
	BB_IC_Stmt( int temp_res);
	~BB_IC_Stmt();

	BB_IC_Stmt & operator=(const BB_IC_Stmt & rhs);
